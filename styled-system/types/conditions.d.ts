...
export interface Conditions {
	...
	"sm": string
	/** `@media screen and (min-width: 36em) and (max-width: 47.9975em)` */
	"smOnly": string
	/** `@media screen and (max-width: 35.9975em)` */
	"smDown": string
	/** `@media screen and (min-width: 48em)` */
	"md": string
	/** `@media screen and (min-width: 48em) and (max-width: 61.9975em)` */
	"mdOnly": string
	/** `@media screen and (max-width: 47.9975em)` */
	"mdDown": string
	/** `@media screen and (min-width: 62em)` */
	"lg": string
	/** `@media screen and (min-width: 62em) and (max-width: 69.3725em)` */
	"lgOnly": string
	/** `@media screen and (max-width: 61.9975em)` */
	"lgDown": string
	/** `@media screen and (min-width: 69.375em)` */
	"xl": string
	/** `@media screen and (min-width: 69.375em) and (max-width: 95.9975em)` */
	"xlOnly": string
	/** `@media screen and (max-width: 69.3725em)` */
	"xlDown": string
	...
	/** `@media screen and (min-width: 36em) and (max-width: 47.9975em)` */
	"smToMd": string
	/** `@media screen and (min-width: 36em) and (max-width: 61.9975em)` */
	"smToLg": string
	/** `@media screen and (min-width: 36em) and (max-width: 69.3725em)` */
	"smToXl": string
	/** `@media screen and (min-width: 36em) and (max-width: 95.9975em)` */
	"smTo2xl": string
	/** `@media screen and (min-width: 48em) and (max-width: 61.9975em)` */
	"mdToLg": string
	/** `@media screen and (min-width: 48em) and (max-width: 69.3725em)` */
	"mdToXl": string
	/** `@media screen and (min-width: 48em) and (max-width: 95.9975em)` */
	"mdTo2xl": string
	/** `@media screen and (min-width: 62em) and (max-width: 69.3725em)` */
	"lgToXl": string
	/** `@media screen and (min-width: 62em) and (max-width: 95.9975em)` */
	"lgTo2xl": string
	/** `@media screen and (min-width: 69.375em) and (max-width: 95.9975em)` */
	"xlTo2xl": string
